---
title: "script6_alternative_pairwise_corr_spearman"
...
#here all modules are significant for atleast one of the diseases except module _01
#Relating modules to physiological traits for A1
```{r}
# For data A1
# Define numbers of genes and samples
...
MEsA1Lnew=MEsA1L[,c("MEHuAgeMSNDsplitRnaseq_02","MEHuAgeMSNDsplitRnaseq_03","MEHuAgeMSNDsplitRnaseq_04","MEHuAgeMSNDsplitRnaseq_05","MEHuAgeMSNDsplitRnaseq_06","MEHuAgeMSNDsplitRnaseq_07","MEHuAgeMSNDsplitRnaseq_08","MEHuAgeMSNDsplitRnaseq_09","MEHuAgeMSNDsplitRnaseq_10","MEHuAgeMSNDsplitRnaseq_11","MEHuAgeMSNDsplitRnaseq_12","MEHuAgeMSNDsplitRnaseq_13","MEHuAgeMSNDsplitRnaseq_14","MEHuAgeMSNDsplitRnaseq_15","MEHuAgeMSNDsplitRnaseq_16","MEHuAgeMSNDsplitRnaseq_17","MEHuAgeMSNDsplitRnaseq_18","MEHuAgeMSNDsplitRnaseq_19","MEHuAgeMSNDsplitRnaseq_20","MEHuAgeMSNDsplitRnaseq_21","MEHuAgeMSNDsplitRnaseq_22","MEHuAgeMSNDsplitRnaseq_23","MEHuAgeMSNDsplitRnaseq_24","MEHuAgeMSNDsplitRnaseq_25","MEHuAgeMSNDsplitRnaseq_26","MEHuAgeMSNDsplitRnaseq_27","MEHuAgeMSNDsplitRnaseq_28")]
...
colorLabels =FALSE,colors=greenWhiteRed(50),textMatrix=textMatrixA1L,
setStdMargins = FALSE, cex.text = 0.60, zlim = c(-1,1),
main = paste("A1_Module-trait relationships labels"))
...
write.csv(modules_celltypes_corr_pearson,"Step21_result_modules_celltypes_colors_corr_pearson_p.csv")
...
write.csv(modules_DEGup_corr_pearson,"Step21_result_modules_DEGup_colors_corr_pearson_p.csv")
...
write.csv(modules_DEGupCON_corr_pearson,"Step21_result_modules_DEGupCON_colors_corr_pearson_p.csv")
...
write.csv(modules_DEGup_corr_pearsonL,"Step21_result_modules_DEGup_labels_corr_pearson_p.csv")
...
write.csv(modules_DEGupCON_corr_pearsonL,"Step21_result_modules_DEGupCON_labels_corr_pearson_p.csv")
...
#Step21: Organization and saving session (software version) information 
```{r}
sessionInfo()
toLatex(sessionInfo())
```
