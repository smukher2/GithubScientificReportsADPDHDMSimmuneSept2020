---
title: "script3_SVAlm_HuAgeDis_MSNDsplitRnaseq_v4"
...
```{r}
#Metadata
metadata=read.csv("Step5D_result_merge_GSE53697_to_GSE100297_metadata_SampleID.csv", header=T, sep=',')

#Expression data
Expr_GeneHu=read.csv("Step5D_result_merge_GSE53697_to_GSE100297_Expr_Gene_SampleID.csv", header =T, sep=',')
...
```{r}
t_pheno_t_edata_all_avg<-cbind(t_pheno_t_edata_Disease_avg, t_pheno_t_edata_Gender_avg, t_pheno_t_edata_Age_avg, t_pheno_t_edata_Tissue_avg)
DT::datatable(head(t_pheno_t_edata_all_avg))
write.csv(t_pheno_t_edata_all_avg, "Step7_result_edata_All_Group_aggregate.csv")
```

```{r}
#save pheno_t_edata, t_pheno_t_edata_Disease_avg, t_pheno_t_edata_Gender_avg, t_pheno_t_edata_Age_avg, t_pheno_t_edata_Tissue_avg, t_pheno_t_edata_all_avg
save(pheno_t_edata, t_pheno_t_edata_Disease_avg, t_pheno_t_edata_Gender_avg, t_pheno_t_edata_Age_avg, t_pheno_t_edata_Tissue_avg, t_pheno_t_edata_all_avg, file="edata_aggregate_data.RData")
```
...
par(mfrow=c(2,1))
                    ...
                    #########boxplot Disease Gender Age Tissue and all ########
...
boxplot(t_pheno_t_edata_all_avg, outline=FALSE, las=2, cex=0.25, main="t_pheno_t_edata_all_avg", col="yellow")
                    ...
                    #########corr plot Disease Gender Age Tissue and all ########
...
pdf(file="Step7_plot_density_edata_aka_expr_aggregate.pdf",height=10,width=10)
                    ...
                    #########density plot Disease Gender Age Tissue and all ########
...
write.csv(mod_coded_metadata, "Step8_result_merge_GSE53697_to_GSE100297_metadata_SampleID_coded.csv")
```
...
mod0 = model.matrix(~as.numeric(Study)+as.numeric(Gender)+as.numeric(Tissue), data=pheno)
...
text(x=pca0$x[,1], y=pca0$x[,2],
     ...
     cex=0.7, font=2)
legend("bottomright",
       legend=c("GSE53697_to_GSE100297"),
...
```{r}
#save pheno_t_edata_lmY, t_pheno_t_edata_lmY_Disease_avg, t_pheno_t_edata_lmY_Gender_avg, t_pheno_t_edata_lmY_Age_avg, t_pheno_t_edata_lmY_Tissue_avg, t_pheno_t_edata_lmY_all_avg
save(pheno_t_edata_lmY, t_pheno_t_edata_lmY_Disease_avg, t_pheno_t_edata_lmY_Gender_avg, t_pheno_t_edata_lmY_Age_avg, t_pheno_t_edata_lmY_Tissue_avg, t_pheno_t_edata_lmY_all_avg, file="edata_lmY_aggregate_data.RData")
```
...
par(mfrow=c(2,1))
                    ...
                    #########boxplot Disease Gender Age and all ########
#box plot on aggregate Disease
...
pdf(file="Step11_plot_density_edata_lmY_aka_expr_aggregate.pdf",height=10,width=10)
                    ...
                    #########density plot Disease Gender Age and all ########
#density plot on aggregate Disease
