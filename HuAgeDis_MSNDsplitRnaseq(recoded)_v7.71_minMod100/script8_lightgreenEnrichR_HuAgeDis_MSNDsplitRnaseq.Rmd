---
title: "script8_lightgreenEnrichR_HuAgeDis_MSNDsplitRnaseq"
...
2)To use this code for different module, change the lightgreen with <nameOfModele> by global replace command
...
mygenes=read.delim('./Module_GeneskMEHubs/lightgreen.txt', header=F, sep='\t')
dim(mygenes)
head(mygenes)
```
...
```{r}
#compare our genes from lightgreen to selected GO process and KEGG pathway
...
write.csv(my_genes_GO_BP_sig0.05_new,file="Step30_result_GO_Biological_Process_2018_sig0.05_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step30_plot_Sig0.05-GO_Biological_Process_plot_", "lightgreen",".pdf"), height=10, width=5)
...
write.csv(my_genes_GO_BP_new,file="Step30_result_GO_Biological_Process_2018_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step30_plot_GO_Biological_Process_plot_", "lightgreen",".pdf"), height=10, width=5)
...
write.csv(my_genes_KEGG_sig0.05_new,file="Step31_result_KEGG_Pathway_2018_sig0.05_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step31_plot_Sig0.05-KEGG_Pathway_plot_", "lightgreen",".pdf"), height=10, width=5)
...
write.csv(my_genes_KEGG_new,file="Step31_result_KEGG_Pathway_2018_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step31_plot_KEGG_Pathway_plot_", "lightgreen",".pdf"), height=10, width=5)
...
write.csv(my_genes_TargetScan_sig0.05_new,file="Step32_result_TargetScan_microRNA_2017_sig0.05_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step32_plot_sig0.05-TargetScan_Pathway_plot_", "lightgreen",".pdf"), height=10, width=5)
...
write.csv(my_genes_TargetScan_new,file="Step32_result_TargetScan_microRNA_2017_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step32_plot_TargetScan_Pathway_plot_", "lightgreen",".pdf"), height=10, width=5)
...
write.csv(my_genes_miRTarBase_sig0.05_new,file="Step33_result_miRTarBase_2017_sig0.05_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step33_plot_sig0.05-miRTarBase_Pathway_plot_", "lightgreen",".pdf"), height=10, width=5)
...
write.csv(my_genes_miRTarBase_new,file="Step33_result_miRTarBase_2017_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step33_plot_miRTarBase_Pathway_plot_", "lightgreen",".pdf"), height=10, width=5)
...
write.csv(my_genes_OMIM_Disease_sig0.05_new,file="Step34_result_OMIM_Disease_sig0.05_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step34_plot_sig0.05-OMIM_Disease_Pathway_plot_", "lightgreen",".pdf"), height=10, width=5)
...
write.csv(my_genes_OMIM_Disease_new,file="Step34_result_OMIM_Disease_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step34_plot_OMIM_Disease_Pathway_plot_", "lightgreen",".pdf"), height=10, width=5)
...
write.csv(my_genes_OMIM_Expanded_sig0.05_new,file="Step35_result_OMIM_Expanded_sig0.05_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step35_plot_sig0.05-OMIM_Expanded_Pathway_plot_", "lightgreen",".pdf"), height=10, width=5)
...
write.csv(my_genes_OMIM_Expanded_new,file="Step35_result_OMIM_Expanded_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step35_plot_OMIM_Expanded_Pathway_plot_", "lightgreen",".pdf"), height=10, width=5)
...
write.csv(my_genes_Human_Gene_Atlas_sig0.05_new,file="Step36_result_Human_Gene_Atlas_sig0.05_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step36_plot_sig0.05-Human_Gene_Atlas_Pathway_plot_", "lightgreen",".pdf"), height=10, width=5)
...
write.csv(my_genes_Human_Gene_Atlas_new,file="Step36_result_Human_Gene_Atlas_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step36_plot_Human_Gene_Atlas_Pathway_plot_", "lightgreen",".pdf"), height=10, width=5)
...
write.csv(my_genes_Mouse_Gene_Atlas_sig0.05_new,file="Step37_result_Mouse_Gene_Atlas_sig0.05_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step37_plot_sig0.05-Mouse_Gene_Atlas_Pathway_plot_", "lightgreen",".pdf"), height=10, width=5)
...
write.csv(my_genes_Mouse_Gene_Atlas_new,file="Step37_result_Mouse_Gene_Atlas_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step37_plot_Mouse_Gene_Atlas_Pathway_plot_", "lightgreen",".pdf"), height=10, width=5)
...
write.csv(my_genes_DrugMatrix_sig0.05_new,file="Step38_result_DrugMatrix_sig0.05_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step38_plot_sig0.05-DrugMatrix_Pathway_plot_", "lightgreen",".pdf"), height=10, width=5)
...
write.csv(my_genes_DrugMatrix_new,file="Step38_result_DrugMatrix_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step38_plot_DrugMatrix_Pathway_plot_", "lightgreen",".pdf"), height=10, width=5)
...
write.csv(my_genes_DSigDB_sig0.05_new,file="Step39_result_DSigDB_sig0.05_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step39_plot_sig0.05-DSigDB_Pathway_plot_", "lightgreen",".pdf"), height=10, width=5)
...
write.csv(my_genes_DSigDB_new,file="Step39_result_DSigDB_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step39_plot_DSigDB_Pathway_plot_", "lightgreen",".pdf"), height=10, width=5)
...
write.csv(my_genes_Epigenomics_Roadmap_HM_ChIPseq_sig0.05_new,file="Step40_result_Epigenomics_Roadmap_HM_ChIP-seq_sig0.05_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step40_plot_sig0.05-Epigenomics_Roadmap_HM_ChIP-seq_Pathway_plot_", "lightgreen",".pdf"), height=10, width=5)
...
write.csv(my_genes_Epigenomics_Roadmap_HM_ChIPseq_new,file="Step40_result_Epigenomics_Roadmap_HM_ChIP-seq_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step40_plot_Epigenomics_Roadmap_HM_ChIP-seq_Pathway_plot_", "lightgreen",".pdf"), height=10, width=5)
...
write.csv(my_genes_ENCODE_and_ChEA_Consensus_TFs_from_ChIPX_sig0.05_new,file="Step41_result_ENCODE_and_ChEA_Consensus_TFs_from_ChIP-X_sig0.05_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step41_plot_sig0.05-ENCODE_and_ChEA_Consensus_TFs_from_ChIP-X_Pathway_plot_", "lightgreen",".pdf"), height=10, width=5)
...
write.csv(my_genes_ENCODE_and_ChEA_Consensus_TFs_from_ChIPX_new,file="Step41_result_ENCODE_and_ChEA_Consensus_TFs_from_ChIP-X_lightgreen.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step41_plot_ENCODE_and_ChEA_Consensus_TFs_from_ChIP-X_Pathway_plot_", "lightgreen",".pdf"), height=10, width=5)
...
```{r}
#save image
save.image(file="lightgreenEnrichR.RData")
```
...
dir.create("lightgreenEnrichR")
file.move(list.files(pattern = "*lightgreen.pdf"), "lightgreenEnrichR")
file.move(list.files(pattern = "*lightgreen.csv"), "lightgreenEnrichR", overwrite = TRUE)
file.move(list.files(pattern = "lightgreenEnrichR.RData"), "lightgreenEnrichR")
```
