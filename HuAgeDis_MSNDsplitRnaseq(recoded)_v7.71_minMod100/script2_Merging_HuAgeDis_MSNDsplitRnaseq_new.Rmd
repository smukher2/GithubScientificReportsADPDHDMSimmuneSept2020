---
title: "script2_Merging_HuAgeDis_MSNDsplitRnaseq_v1"
...
#Checklist for this pipeline 
  #1) GEO series number from publication or searching GEO for dataset of interest, here GSE=GSE53697_to_GSE100297. And their respective GPL gene annotation files
  #2) metadata file made by manually combining individual metadata files from GEO to give '(original)merge_GSE53697_GSE68719_GSE64810_GSE67333_GSE100297_metadata_edit_v4' which was further edited manually to give '(manual)merge_GSE53697_to_GSE100297_metadata_edit_v7_HuAgeMSNDsplitRnaseq.csv' 
...
####################################Merging GSE53697_GSE68719_GSE64810_GSE67333_GSE100297####################################### 
...
```{r}
#125 columns i.e. 125 samples + 1 column of genes, number of rows is the total number of gene annotations
dim(htseqCount2)
...
#The individual_metadata.csv to make merged '(original)merge_GSE53697_GSE68719_GSE64810_GSE67333_GSE100297_metadata_edit_v4'
```{r}
merge_metadata=read.csv('./InputMetadata&Lists/(manual)merge_GSE53697_to_GSE100297_metadata_edit_v7_HuAgeMSNDsplitRnaseq.csv', header =T, sep=',')
...
```
  ...
  #4.4 Visualization of merged GSE53697_to_GSE100297
```{r}
pdf(file="Step4_plot_Visualization_GSE53697_to_GSE100297_rawdata_transformation.pdf",height=5,width=5)
...
```
  ...
  #4.5 Visualization of merged GSE53697_to_GSE100297 few samples
```{r}
pdf(file="Step4_plot_Visualization_GSE53697_to_GSE100297_rawdata_transformation_FewSamples.pdf",height=5,width=5)
par(mfrow=c(2,1)) #plots are big, so put two per page
...
write.csv(htseqCount2_matched_tpmlog,"Step5D_result_merge_GSE53697_to_GSE100297_Expr_Gene_SampleID.csv")
write.csv(merge_metadata,"Step5D_result_merge_GSE53697_to_GSE100297_metadata_SampleID.csv")
```
