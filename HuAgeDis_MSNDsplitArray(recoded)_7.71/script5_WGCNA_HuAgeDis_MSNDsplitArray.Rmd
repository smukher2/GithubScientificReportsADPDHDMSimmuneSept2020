---
title: "script5_WGCNA_HuAgeDis_MSNDsplit_v1"
...
To reuse this code for other datasets 
  a) replace "HuAgeMSNDsplit_" for module naming to pre-fix of users choice that is meaningful for the dataset. Here Hu=Human, Age=Age, Dis=Disease
...
```{r}
#Human Metadata
metadata=read.csv("./merged_expr_metadata/Step5D_result_merge_GSE33000_to_GSE43490_metadata_SampleID.csv", header=T, sep=',')
colnames(metadata)
```
...
metadata_coded=read.csv("./merged_expr_metadata/Step8_result_merge_GSE33000_to_GSE43490_metadata_SampleID_coded_vsCONown.csv", header=T, sep=',')
...
#Order of metadata variable selection in WGCNA same as mod and then remaining variables
#keep only variable we need
metadata_1_coded=metadata_coded[,c("StudyGSE20164","StudyGSE20292","StudyGSE26927","StudyGSE33000","StudyGSE20333","GenderM","DiseaseCON","DiseaseAD","DiseaseHD","DiseasePD","DiseaseMS","Age","Tissuecortex_brain","Tissuesubstantia_nigra_brain")]
...
#To select only a given number of top genes like top variable 12500 genes uncomment line below
#dat2 = dat1[1:dim(datExprA1g1)[1],1:12500]
...
minClusterSize = (30-3*ds), cutHeight = 1.00,
deepSplit = ds, distM = dissTOMA1)
mColorh=cbind(mColorh,labels2colors(tree$labels));
mColorhL=cbind(mColorhL, paste("HuAgeMSNDsplit_", str_pad(tree$labels, 2, pad="0"), sep="" ))
}
...
write.csv(datExprA1g2,"Step20_result_ForPres&Hyper_HuAgeMSNDsplit_datExprA1g2.csv")
#Export the module and gene names for use Preservation and hypergeometric test 
write.csv(kMEtable1[,c("PSID","Gene","Module")],"Step20_result_ForPres&Hyper_HuAgeMSNDsplit_GeneModule.csv")
write.csv(kMEtable1L[,c("PSID","Gene","Module")],"Step20_result_ForPres&Hyper_HuAgeMSNDsplit_GeneModuleL.csv")
```
...
sig_mod_names<-c("HuAgeMSNDsplit_01","HuAgeMSNDsplit_02","HuAgeMSNDsplit_03","HuAgeMSNDsplit_04","HuAgeMSNDsplit_05","HuAgeMSNDsplit_06","HuAgeMSNDsplit_07","HuAgeMSNDsplit_08","HuAgeMSNDsplit_09","HuAgeMSNDsplit_10","HuAgeMSNDsplit_11","HuAgeMSNDsplit_12","HuAgeMSNDsplit_13","HuAgeMSNDsplit_14","HuAgeMSNDsplit_15","HuAgeMSNDsplit_16","HuAgeMSNDsplit_17","HuAgeMSNDsplit_18","HuAgeMSNDsplit_19","HuAgeMSNDsplit_20","HuAgeMSNDsplit_21","HuAgeMSNDsplit_22")
