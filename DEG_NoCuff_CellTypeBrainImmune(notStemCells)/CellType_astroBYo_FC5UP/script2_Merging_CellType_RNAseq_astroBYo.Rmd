---
title: "script2_Merging_CellType_astroBYo_v1"
...
#Checklist for this pipeline 
  ...
  #2) metadata file made by manually combining individual metadata files from GEO to give '(original)merge_GSE52564_GSE86573_SRP035309_metadata_edit_v3' which was further edited manually to give '(manual)merge_GSE52564_GSE86573_SRP035309_metadata_edit_v3_astroBYo.csv' 
...
```{r}
merge_metadata=read.csv('./InputMetadata&Lists/(manual)merge_GSE52564_GSE86573_SRP035309_metadata_edit_v3_astroBYo.csv', header =T, sep=',')
