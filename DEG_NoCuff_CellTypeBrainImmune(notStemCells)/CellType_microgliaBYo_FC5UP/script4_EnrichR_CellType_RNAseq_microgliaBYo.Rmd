---
title: "script4_EnrichR_CellType_microgliaBYo"
...
write.csv(mygenes, "ForWGCNA_DEGup_microgliaBYo.csv")
```
...
```{r}
#compare our genes from microgliaBYo to selected GO process and KEGG pathway
...
write.csv(my_genes_GO_BP_sig0.05_new,file="Step27_result_GO_Biological_Process_2018_sig0.05_microgliaBYo.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step27_plot_Sig0.05-GO_Biological_Process_plot_", "microgliaBYo",".pdf"), height=10, width=5)
...
write.csv(my_genes_GO_BP_new,file="Step27_result_GO_Biological_Process_2018_microgliaBYo.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step27_plot_GO_Biological_Process_plot_", "microgliaBYo",".pdf"), height=10, width=5)
...
write.csv(my_genes_KEGG_sig0.05_new,file="Step28_result_KEGG_Pathway_2018_sig0.05_microgliaBYo.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step28_plot_Sig0.05-KEGG_Pathway_plot_", "microgliaBYo",".pdf"), height=10, width=5)
...
write.csv(my_genes_KEGG_new,file="Step28_result_KEGG_Pathway_2018_microgliaBYo.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step28_plot_KEGG_Pathway_plot_", "microgliaBYo",".pdf"), height=10, width=5)
...
write.csv(my_genes_TargetScan_sig0.05_new,file="Step29_result_TargetScan_microRNA_2017_sig0.05_microgliaBYo.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step29_plot_sig0.05-TargetScan_Pathway_plot_", "microgliaBYo",".pdf"), height=10, width=5)
...
write.csv(my_genes_TargetScan_new,file="Step29_result_TargetScan_microRNA_2017_microgliaBYo.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step29_plot_TargetScan_Pathway_plot_", "microgliaBYo",".pdf"), height=10, width=5)
...
write.csv(my_genes_miRTarBase_sig0.05_new,file="Step30_result_miRTarBase_2017_sig0.05_microgliaBYo.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step30_plot_sig0.05-miRTarBase_Pathway_plot_", "microgliaBYo",".pdf"), height=10, width=5)
...
write.csv(my_genes_miRTarBase_new,file="Step30_result_miRTarBase_2017_microgliaBYo.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step30_plot_miRTarBase_Pathway_plot_", "microgliaBYo",".pdf"), height=10, width=5)
...
write.csv(my_genes_OMIM_Disease_sig0.05_new,file="Step31_result_OMIM_Disease_sig0.05_microgliaBYo.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step31_plot_sig0.05-OMIM_Disease_Pathway_plot_", "microgliaBYo",".pdf"), height=10, width=5)
...
write.csv(my_genes_OMIM_Disease_new,file="Step31_result_OMIM_Disease_microgliaBYo.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step31_plot_OMIM_Disease_Pathway_plot_", "microgliaBYo",".pdf"), height=10, width=5)
...
write.csv(my_genes_OMIM_Expanded_sig0.05_new,file="Step32_result_OMIM_Expanded_sig0.05_microgliaBYo.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step32_plot_sig0.05-OMIM_Expanded_Pathway_plot_", "microgliaBYo",".pdf"), height=10, width=5)
...
write.csv(my_genes_OMIM_Expanded_new,file="Step32_result_OMIM_Expanded_microgliaBYo.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step32_plot_OMIM_Expanded_Pathway_plot_", "microgliaBYo",".pdf"), height=10, width=5)
...
write.csv(my_genes_Human_Gene_Atlas_sig0.05_new,file="Step33_result_Human_Gene_Atlas_sig0.05_microgliaBYo.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step33_plot_sig0.05-Human_Gene_Atlas_Pathway_plot_", "microgliaBYo",".pdf"), height=10, width=5)
...
write.csv(my_genes_Human_Gene_Atlas_new,file="Step33_result_Human_Gene_Atlas_microgliaBYo.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step33_plot_Human_Gene_Atlas_Pathway_plot_", "microgliaBYo",".pdf"), height=10, width=5)
...
write.csv(my_genes_Mouse_Gene_Atlas_sig0.05_new,file="Step34_result_Mouse_Gene_Atlas_sig0.05_microgliaBYo.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step34_plot_sig0.05-Mouse_Gene_Atlas_Pathway_plot_", "microgliaBYo",".pdf"), height=10, width=5)
...
write.csv(my_genes_Mouse_Gene_Atlas_new,file="Step34_result_Mouse_Gene_Atlas_microgliaBYo.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step34_plot_Mouse_Gene_Atlas_Pathway_plot_", "microgliaBYo",".pdf"), height=10, width=5)
...
write.csv(my_genes_DrugMatrix_sig0.05_new,file="Step35_result_DrugMatrix_sig0.05_microgliaBYo.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step35_plot_sig0.05-DrugMatrix_Pathway_plot_", "microgliaBYo",".pdf"), height=10, width=5)
...
write.csv(my_genes_DrugMatrix_new,file="Step35_result_DrugMatrix_microgliaBYo.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step35_plot_DrugMatrix_Pathway_plot_", "microgliaBYo",".pdf"), height=10, width=5)
...
write.csv(my_genes_DSigDB_sig0.05_new,file="Step36_result_DSigDB_sig0.05_microgliaBYo.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step36_plot_sig0.05-DSigDB_Pathway_plot_", "microgliaBYo",".pdf"), height=10, width=5)
...
write.csv(my_genes_DSigDB_new,file="Step36_result_DSigDB_microgliaBYo.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step36_plot_DSigDB_Pathway_plot_", "microgliaBYo",".pdf"), height=10, width=5)
...
write.csv(my_genes_ENCODE_and_ChEA_Consensus_TFs_from_ChIPX_sig0.05_new,file="Step37_result_ENCODE_and_ChEA_Consensus_TFs_from_ChIP-X_sig0.05_microgliaBYo.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step37_plot_sig0.05-ENCODE_and_ChEA_Consensus_TFs_from_ChIP-X_Pathway_plot_", "microgliaBYo",".pdf"), height=10, width=5)
...
write.csv(my_genes_ENCODE_and_ChEA_Consensus_TFs_from_ChIPX_new,file="Step37_result_ENCODE_and_ChEA_Consensus_TFs_from_ChIP-X_microgliaBYo.csv")
```

```{r}
# Basic barplot
folder=getwd()
pdf(paste0("Step37_plot_ENCODE_and_ChEA_Consensus_TFs_from_ChIP-X_Pathway_plot_", "microgliaBYo",".pdf"), height=10, width=5)
...
```{r}
#save image
save.image(file="microgliaBYoEnrichR.RData")
```
...
dir.create("microgliaBYoEnrichR")
file.move(list.files(pattern = "*microgliaBYo.pdf"), "microgliaBYoEnrichR")
file.move(list.files(pattern = "*microgliaBYo.csv"), "microgliaBYoEnrichR", overwrite = TRUE)
file.move(list.files(pattern = "microgliaBYoEnrichR.RData"), "microgliaBYoEnrichR")
```
